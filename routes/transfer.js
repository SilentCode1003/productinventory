...
router.post('/save', (req, res) => {
  try {
    const { assetcontrol, serial, date, transferby, from, receiveby, to, referenceno } = req.body
    let transfer = [[assetcontrol, serial, date, transferby, from, receiveby, to, referenceno]]
...
function Check_Transfer(assetcontrol, date, from, to) {
  return new Promise((resolve, reject) => {
    let sql = 'select * from transfer where t_assetcontrol=? and t_date=? and t_from=? and t_to=?'
